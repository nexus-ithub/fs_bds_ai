  ...
  return (
    <Dialog
      ...
      <div className="w-[1060px]">
        ...
        <div className="w-full flex flex-col h-[calc(100vh-300px)] px-[20px] overflow-y-auto divide-y divide-line-03">
          {loading ? (  
            ...
            <div key={index} className="flex space-x-[24px] py-[20px]">
