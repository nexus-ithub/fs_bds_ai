...
export const Support = () => {
  ...
  return (
    <div className="flex flex-col w-[1920px] h-full">
      <div 
        className="flex flex-col items-center justify-center w-[1920px] h-[360px] flex-shrink-0"
        style={{
      ...
      <div className="w-[1024px] flex flex-col gap-[32px] mx-auto px-[32px] py-[48px]">
        <div className="flex flex-col gap-[16px]">
          <div className="flex items-center gap-[8px]">
            ...
            <span className="font-s3 cursor-pointer">전체 보기</span>
          </div>
