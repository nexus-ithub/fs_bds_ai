...
export const BusinessDistrict = React.forwardRef<HTMLDivElement, { businessDistrict: DistrictInfo[] }>(({businessDistrict = []}, ref) => {
...
BusinessDistrict.displayName = 'BusinessDistrict';