              ...
              <div className="space-y-[16px]">
                ...
                <div className="p-[16px] gap-[16px] flex rounded-[8px] border-[1px] border-line-03 divide-x-[1px] divide-line-02">
                  ...
                  <div className="flex-1 flex flex-col space-y-[12px] pr-[16px]">
                    ...
                    <HDivider />
                    <p className="flex-1 text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center">{aiReportDetail?.result?.avgPublicLandPriceGrowthRate.toFixed(2)}%</p>
                  </div>
