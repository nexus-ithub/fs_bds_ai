...
import { AIReportLogo, BuildingShopBIMain, BuildingShopBIText, Button, CloseIcon, DotProgress, getAreaStrWithPyeong, getRatioStr, HDivider, krwUnit, VDivider, type AIReportDetail } from "@repo/common";
    ...
    return (
      <div className="items-center space-y-[16px] w-full">
        ...
        <div className="w-full overflow-x-auto">
          <div className="min-w-[800px] px-[26px] relative h-[162px] py-[14px]">
            {/* ticks */}
  ...
  return (
    <>
      ...
      >
        ...
        {
          loading ?
            <div className="flex-1 flex flex-col items-center justify-center h-[calc(100vh-268px)]">
              <DotProgress />
            </div>
            :
            <div className="space-y-[16px] md:space-y-[24px] px-[16px] md:px-[24px] flex-1 overflow-y-auto md:max-h-[calc(100vh-268px)] py-[16px] md:py-[24px]">
              <div className="space-y-[6px]">
                <p className="font-h3 md:font-h2">추천 항목 상세 리포트</p>
                <p className="font-s3 md:font-s2 text-text-03">해당 물건을 분석하여 건축 ∙ 리모델링 ∙ 임대 중 추천하는 항목의 상세 리포트를 제공해 드립니다. </p>
              </div>
              <p className="w-full font-s3 md:font-s2 text-red-500 bg-red-100 px-[12px] md:px-[16px] py-[10px] md:py-[12px] rounded-[4px] space-y-[4px]">
                <p>
              ...
              <div className="space-y-[12px] md:space-y-[16px]">
                <p className="font-h4 md:font-h3">부동산 개요</p>
                <div className="p-[12px] md:p-[16px] flex flex-col md:flex-row rounded-[8px] border-[1px] border-line-03 divide-y-[1px] md:divide-y-0 md:divide-x-[1px] divide-line-02">
                  <div className="flex-1 space-y-[10px] md:space-y-[12px] pb-[12px] md:pb-0 md:pr-[16px]">
                  ...
                  <div className="flex-1 space-y-[10px] md:space-y-[12px] pt-[12px] md:pt-0 md:pl-[16px]">
              ...
              <div className="space-y-[12px] md:space-y-[16px]">
                <p className="font-h4 md:font-h3">기획설계</p>
                <div className="p-[12px] md:p-[16px] flex flex-col md:flex-row rounded-[8px] border-[1px] border-line-03 divide-y-[1px] md:divide-y-0 md:divide-x-[1px] divide-line-02">
                  <div className="flex-1 flex flex-col divide-y-[1px] divide-line-02 pb-[12px] md:pb-0 md:pr-[16px]">
                    ...
                    <p className="flex-1 text-[28px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center py-[8px] md:py-0">{aiReportDetail?.result?.grade}</p>
                  </div>
                  {
              ...
              </div>
              {
                aiReportDetail?.type !== 'rent' ? (
                  <div className="space-y-[12px] md:space-y-[16px]">
                    <p className="font-h4 md:font-h3">사업기간</p>
                    <div className="p-[12px] md:p-[16px] rounded-[8px] border-[1px] border-line-03 overflow-hidden">
                      {renderDuration()}
                    </div>
                  </div>
                ) : null
              ...
              <div className="space-y-[12px] md:space-y-[16px]">
                <div className="flex items-center gap-[8px]">
                  <p className="font-h4 md:font-h3">사업비</p>
                </div>
                <div className="p-[12px] md:p-[16px] flex flex-col md:flex-row rounded-[8px] border-[1px] border-line-03 divide-y-[1px] md:divide-y-0 md:divide-x-[1px] divide-line-02">
                  <div className="flex-1 flex flex-col space-y-[10px] md:space-y-[12px] pb-[12px] md:pb-0 md:pr-[16px]">
                    ...
                    <ItemRow title="공사비 및 ENG 용역비" value={krwUnit(aiReportDetail?.value?.projectCost.constructionCost + aiReportDetail?.value?.projectCost.managementCost + aiReportDetail?.value?.projectCost.pmFee)} />
                  ...
                  <div className="flex flex-col flex-1 pt-[12px] md:pt-0 md:pl-[16px] divide-y-[1px] divide-line-02">
                    <div className="flex items-center justify-center pb-[12px]">
                      <p className="font-h4">총사업비</p>
                    </div>
                    <p className="flex-1 text-[24px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center py-[8px] md:py-0">{
                      krwUnit(
              ...
              <div className="space-y-[12px] md:space-y-[16px]">
                <div className="flex items-center gap-[8px]">
                  <p className="font-h4 md:font-h3">수익/지출</p>
                </div>
                <div className="p-[12px] md:p-[16px] flex flex-col md:flex-row rounded-[8px] border-[1px] border-line-03 divide-y-[1px] md:divide-y-0 md:divide-x-[1px] divide-line-02">
                  <div className="flex-1 flex flex-col space-y-[10px] md:space-y-[12px] pb-[12px] md:pb-0 md:pr-[16px]">
                  ...
                  <div className="flex flex-col flex-1 pt-[12px] md:pt-0 md:pl-[16px] divide-y-[1px] divide-line-02">
                    <div className="flex items-center justify-center pb-[12px]">
                      <p className="font-s3 md:font-h4 text-center">연간 순수익(임대수익-연간지출)</p>
                    </div>
                    <p className="flex-1 text-[24px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center py-[8px] md:py-0">{krwUnit(aiReportDetail?.result?.annualRentProfit - (aiReportDetail?.value?.loan.loanInterestPerYear + aiReportDetail?.tax?.propertyTax + aiReportDetail?.tax?.propertyTaxForBuilding + aiReportDetail?.tax?.comprehensiveRealEstateTax), true)}</p>
                  </div>
                </div>
              </div>
              <div className="space-y-[12px] md:space-y-[16px]">
                <p className="font-h4 md:font-h3">최종</p>
                <div className="p-[12px] md:p-[16px] gap-[12px] md:gap-[16px] grid grid-cols-2 md:flex rounded-[8px] border-[1px] border-line-03">
                  <div className="flex-1 flex flex-col space-y-[8px] md:space-y-[12px] p-[8px] md:p-0 border md:border-0 border-line-02 rounded-[4px] md:rounded-none md:border-r md:pr-[16px]">
                    <p className="font-s3 md:font-h4 text-center">초기자본금</p>
                    <HDivider className="hidden md:block" />
                    <p className="flex-1 text-[18px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center">{krwUnit(aiReportDetail?.result?.initialCapital, true)}</p>
                  </div>
                  <div className="flex-1 flex flex-col space-y-[8px] md:space-y-[12px] p-[8px] md:p-0 border md:border-0 border-line-02 rounded-[4px] md:rounded-none md:border-r md:pr-[16px]">
                    <p className="font-s3 md:font-h4 text-center">임대수익률</p>
                    <HDivider className="hidden md:block" />
                    <p className="flex-1 text-[18px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center">{(aiReportDetail?.result?.profitRatio * 100).toFixed(1)}%</p>
                  </div>
                  <div className="flex-1 flex flex-col space-y-[8px] md:space-y-[12px] p-[8px] md:p-0 border md:border-0 border-line-02 rounded-[4px] md:rounded-none md:border-r md:pr-[16px]">
                    <p className="font-s3 md:font-h4 text-center">5년 평균 지가 상승률</p>
                    <HDivider className="hidden md:block" />
                    <p className="flex-1 text-[18px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center">{(aiReportDetail?.result?.avgPublicLandPriceGrowthRate * 100).toFixed(1)}%</p>
                  </div>
                  <div className="flex-1 flex flex-col space-y-[8px] md:space-y-[12px] p-[8px] md:p-0 border md:border-0 border-line-02 rounded-[4px] md:rounded-none">
                    ...
                    <HDivider className="hidden md:block" />
                    <p className="flex-1 text-[18px] md:text-[34px] text-primary font-[var(--font-weight-bold)] flex items-center justify-center">{krwUnit(aiReportDetail?.result?.expectedSaleAmount, true)}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="sticky bottom-0 bg-white">
          ...
          <div className="w-full flex p-[16px] md:p-[24px] gap-[10px]">
            <Button variant="bggray" fontSize="font-s1 md:font-h4" size="medium" className="flex-1" onClick={() => { onClose() }}>닫기</Button>
            <Button className="flex-1" fontSize="font-s1 md:font-h4" size="medium" onClick={() => { setOpenConsultRequestDialog(true) }}>상담문의</Button>
          </div>
        </div>
